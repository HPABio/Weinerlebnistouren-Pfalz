      ...
      <div className=" w-full mx-auto relative z-10">
        <div className="bg-gradient-to-br from-stone-50/85 to-stone-100/50 rounded-xl shadow-lg border border-stone-200/50 p-6 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="flex-1 md:w-2/3 lg:w-full text-center md:text-left leading-tight">
              <h3 className="text-xl md:text-2xl lg:text-4xl font-bold font-bonanova tracking-tight mb-3 md:leading-tight">
                <span className="text-accent1/80">
                  Kann ich Ihnen weiterhelfen?
                </span>
              </h3>
              <p className="md:max-w-72 lg:max-w-80  sm:text-sm md:text-sm lg:text-lg text-text/60 font-normal md:mt-8 md:mb-2 lg:mb-4 sm:leading-tight md:leading-snug lg:leading-snug">
                Melden Sie sich gerne bei mir und ich beantworte alle offenen
                Fragen zu unseren Wein-Erlebnistouren.
              </p>
              <div className="w-[320px] md:w-[360px] flex justify-start mb-2 mt-6 lg:mb-0 rounded-full bg-gradient-to-r from-accent1/20 to-accent1/10">
...
"
                  ...
                  <a
                    ...
                    <svg
                      className=" w-5 aspect-square mr-1 md:mr-2"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path
            ...
            <div className="lg:flex flex-col gap-3 lg:w-1/3 hidden border-0 border-red-500 pb-5">
          ...
          <p className="mx-auto font-light text-text/80 text-center md:text-base xl:text-xl w-full relative z-10 md:mt-4 lg:mt-6 md:leading-tight">
        ...
        <div className="w-fit h-fit absolute top-0 right-[0%] sm:translate-x-[-5%] sm:translate-y-[-46%] md:translate-x-[-5%] md:translate-y-[-16%] lg:translate-x-[-20%] lg:translate-y-[-30%]">
          <img
            ...
            className="relative w-[200px] object-cover opacity-85"
          />
        </div>
      </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            <div className="flex-1 md:w-2/3 md:max-w- lg:w-2/3 text-center md:text-left leading-tight">
              <h3 className="sm:text-xl text-left font-bold font-bonanova tracking-tight sm:leading-none mb-4 sm:mb-4">
                <span className="text-accent1/80">
                  Sie haben noch <br className="md:hidden block" />
                  offene Fragen?
                </span>
              </h3>
              <p className="max-w-44 sm:max-w-64 text-[13px] sm:text-sm text-left text-stone-600/50 sm:text-stone-600/70 font-normal mb-4 sm:mb-0 lg:mb-4 sm:leading-snug">
                Ich helfe Ihnen <br className="sm:hidden block" /> gerne weiter
                und <br /> beantworte alle <br className="sm:hidden block" />{" "}
                Ihre Fragen zu unseren <br />
                Wein-Erlebnistouren.
              </p>
              <div className="flex md:justify-start justify-center my-5 md:my-3">
                <a
                  ...
                  <svg
                    className="rotate-180 w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24">
                    <path
